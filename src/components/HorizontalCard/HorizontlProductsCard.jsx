...
const HorizontlProductsCard = ({product}) => {
    ...
    <div className="card-horizontal d-flex shadow m-5 p-1">
      ...
      <div className="card-details d-flex direction-column">
        ...
        <div className="cta-btn d-flex gap">
                <button onClick={()=>onRemoveClick(product)} className="button hori-btn btn-primary btn-icon d-flex align-center justify-center gap cursor btn-margin text"> Remove from Cart</button>
            
            <div className="cta-btn">
                <button className="button hori-btn btn-outline-primary btn-icon d-flex align-center justify-center gap cursor btn-margin text">Move to wishlist</button>
            </div>
      </div>
      </div>
    </div>
...
export default HorizontlProductsCard;
